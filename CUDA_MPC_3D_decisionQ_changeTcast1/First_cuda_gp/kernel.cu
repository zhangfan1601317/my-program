//在MPC模型中将h改为Q,拉速保持不变1.2m/min,改变浇注温度
...
cudaError_t addWithCuda(float *T_Init, float dx, float dy, float dz, float tao, int nx, int ny, int nz, int tnpts, int num_blocks, int num_threadsx, int num_threadsy)
{
	...
	{			
		...
		for (int temp = 0; temp < Section; temp++)
		{
			...
			if (t == 9000)
			{
				...
				fout.open("F:\\data_zf\\changeTcastSurTGPUMPC.txt");
				if (!fout)
					cout << "changeTcastSurTGPUMPC is not open" << endl;
				else
				{
					for (int j = 0; j < ny; j++)
					{
			...
			if (t == 10600)
			{
				fout.open("F:\\data_zf\\changeTcastSurTGPUMPCTwoMinutes.txt");
				if (!fout)
					cout << "changeTcastSurTGPUMPCTwoMinutes is not open" << endl;
				else
				{
					for (int j = 0; j < ny; j++)
					{
			...
			if (t == 10300)
			{
				fout.open("F:\\data_zf\\changeTcastSurTGPUMPCOneMinute.txt");
				if (!fout)
					cout << "changeTcastSurTGPUMPCOneMinute is not open" << endl;
				else
				{
					for (int j = 0; j < ny; j++)
					{
			...
			if (t == 11500)
			{
				fout.open("F:\\data_zf\\changeTcastSurTGPUMPCFiveMinutes.txt");
				if (!fout)
					cout << "changeTcastSurTGPUMPCFiveMinutes is not open" << endl;
				else
				{
					for (int j = 0; j < ny; j++)
					{
			...
			if (t == 13000)
			{
				fout.open("F:\\data_zf\\changeTcastSurTGPUMPCTenMinutes.txt");
				if (!fout)
					cout << "changeTcastSurTGPUMPCTenMinutes is not open" << endl;
				else
				{
					for (int j = 0; j < ny; j++)
					{
			...
			if (t == 16000)
			{
				fout.open("F:\\data_zf\\changeTcastSurTGPUMPCTwentyMinutes.txt");
				if (!fout)
					cout << "changeTcastSurTGPUMPCTwentyMinutes is not open" << endl;
				else
				{
					for (int j = 0; j < ny; j++)
					{
			...
			if (t == 19000)
			{
				fout.open("F:\\data_zf\\changeTcastSurTGPUMPCThirtyMinutes.txt");
				if (!fout)
					cout << "changeTcastSurTGPUMPCThirtyMinutes is not open" << endl;
				else
				{
					for (int j = 0; j < ny; j++)
					{
	...
	ofstream fout;
		...
		fout.open("F:\\data_zf\\changeTcastAveSurfaceTemperature.txt");
		if (!fout)
			cout << "changeTcastAveSurfaceTemperature is not open" << endl;
		else
		{
			for (int i = 0; i < TestIter; i++)
			{
		...
		fout.open("F:\\data_zf\\changeTcastLiquidLine.txt");
		if (!fout)
			cout << "changeTcastLiquidLine is not open" << endl;
		else
		{
			for (int i = 0; i < TestIter; i++)
			{
