...
cudaError_t addWithCuda(float *T_Init, float dx, float dy, float dz, float tao, int nx, int ny, int nz, int tnpts, int num_blocks, int num_threadsx, int num_threadsy)
{
	...
	ofstream fout;
		fout.open("F:\\data_zf\\high_hGPUMPC3D2block3threads.txt");
		if (!fout)
			cout << "high_hGPUMPC3D2block3threads is not open" << endl;
		else
		{
			for (int j = 0; j < ny; j++)
			{
		...
		fout.open("F:\\data_zf\\high_hSurfaceGPUMPC3D2block3threads.txt");
		if (!fout)
			cout << "high_hSurfaceGPUMPC3D2block3threads is not open" << endl;
		else 
		{
			for (int j = 0; j < ny; j++)
			{
		...
		fout.open("F:\\data_zf\\high_hCenterGPUMPC3D2block3threads.txt");
		if (!fout)
			cout << "high_hCenterGPUMPC3D2block3threads is not open" << endl;
		else
		{
			for (int j = 0; j < ny; j++)
			{
		...
		fout.open("F:\\data_zf\\high_hSurfaceErrorGPUMPC3D2block3threads.txt");
		if (!fout)
			cout << "high_hSurfaceErrorGPUMPC3D2block3threads is not open" << endl;
		else
		{
		...
		fout.open("F:\\data_zf\\high_hThicknessGPUMPC3D2block3threads.txt");
		if (!fout)
			cout << "high_hThicknessGPUMPC3D2block3threads is not open" << endl;
		else
		{
			for (int i = 0; i < CoolSection; i++) {
		...
		fout.open("F:\\data_zf\\high_hlamda.txt");
		if (!fout)
			cout << "high_hlamda is not open" << endl;
		else
		{
		...
		fout.open("F:\\data_zf\\high_hgtest.txt");
		if (!fout)
			cout << "high_hgtest is not open" << endl;
		else
		{
			for (int i = 0; i < TestIter; i++)
			{
		...
		fout.open("F:\\data_zf\\high_hhtest.txt");
		if (!fout)
			cout << "high_hhtest is not open" << endl;
		else
		{
			for (int i = 0; i < TestIter; i++)
			{
		...
		fout.open("F:\\data_zf\\high_hfitnesstest.txt");
		if (!fout)
			cout << "high_hfitnesstest is not open" << endl;
		else
		{
			for (int i = 0; i < TestIter; i++)
			{
		...
		fout.open("F:\\data_zf\\high_hc.txt");
		if (!fout)
			cout << "high_hc is not open" << endl;
		else
		{
			for (int i = 0; i < TestIter; i++)
			{
		...
		fout.open("F:\\data_zf\\high_hstep.txt");
		if (!fout)
			cout << "high_hstep is not open" << endl;
		else
		{
			for (int i = 0; i < TestIter; i++)
			{
