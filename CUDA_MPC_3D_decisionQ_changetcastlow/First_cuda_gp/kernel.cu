...
int main()
{
	...
	float T_Cast = 1358.0;// T_Cast = 1558.0,
...
cudaError_t addWithCuda(float *T_Init, float dx, float dy, float dz, float tao, int nx, int ny, int nz, int tnpts, int num_blocks, int num_threadsx, int num_threadsy)
{
	...
	ofstream fout;
		fout.open("F:\\data_zf\\LowTcastGPUMPC3D2block3threads.txt");
		if (!fout)
			cout << "LowTcastGPUMPC3D2block3threads is not open" << endl;
		else
		{
			for (int j = 0; j < ny; j++)
			{
		...
		fout.open("F:\\data_zf\\LowTcastSurfaceGPUMPC3D2block3threads.txt");
		if (!fout)
			cout << "LowTcastSurfaceGPUMPC3D2block3threads is not open" << endl;
		else 
		{
			for (int j = 0; j < ny; j++)
			{
		...
		fout.open("F:\\data_zf\\LowTcastCenterGPUMPC3D2block3threads.txt");
		if (!fout)
			cout << "LowTcastCenterGPUMPC3D2block3threads is not open" << endl;
		else
		{
			for (int j = 0; j < ny; j++)
			{
		...
		fout.open("F:\\data_zf\\LowTcastSurfaceErrorGPUMPC3D2block3threads.txt");
		if (!fout)
			cout << "LowTcastSurfaceErrorGPUMPC3D2block3threads is not open" << endl;
		else
		{
		...
		fout.open("F:\\data_zf\\LowTcastThicknessGPUMPC3D2block3threads.txt");
		if (!fout)
			cout << "LowTcastThicknessGPUMPC3D2block3threads is not open" << endl;
		else
		{
			for (int i = 0; i < CoolSection; i++) {
		...
		fout.open("F:\\data_zf\\LowTcastlamda.txt");
		if (!fout)
			cout << "LowTcastlamda is not open" << endl;
		else
		{
		...
		fout.open("F:\\data_zf\\LowTcastgtest.txt");
		if (!fout)
			cout << "LowTcastgtest is not open" << endl;
		else
		{
			for (int i = 0; i < TestIter; i++)
			{
		...
		fout.open("F:\\data_zf\\LowTcasthtest.txt");
		if (!fout)
			cout << "LowTcasthtest is not open" << endl;
		else
		{
			for (int i = 0; i < TestIter; i++)
			{
		...
		fout.open("F:\\data_zf\\LowTcastfitnesstest.txt");
		if (!fout)
			cout << "LowTcastfitnesstest is not open" << endl;
		else
		{
			for (int i = 0; i < TestIter; i++)
			{
		...
		fout.open("F:\\data_zf\\LowTcastc.txt");
		if (!fout)
			cout << "LowTcastc is not open" << endl;
		else
		{
			for (int i = 0; i < TestIter; i++)
			{
		...
		fout.open("F:\\data_zf\\LowTcaststep.txt");
		if (!fout)
			cout << "LowTcaststep is not open" << endl;
		else
		{
			for (int i = 0; i < TestIter; i++)
			{
